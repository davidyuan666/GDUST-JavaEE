...
<form id="products">
    <table border="1">
        ...
        <tr>
            ...
            <td><input name="proName" value="三文鱼" id="proName" type="text" class="proNameClass"></td>
...
<script type="text/javascript">
    ...
    function submitProducts() {
        var pro1 = {proId: $("#proId").val(), proName: $(".proNameClass").val()}
